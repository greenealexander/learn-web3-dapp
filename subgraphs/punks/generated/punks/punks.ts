...
export class punks__punksOfferedForSaleResult {
  value0: boolean;
  value1: BigInt;
  value2: Address;
  value3: BigInt;
...
export class punks__punkBidsResult {
  value0: boolean;
  value1: BigInt;
  value2: Address;
  value3: BigInt;
...
export class punks extends ethereum.SmartContract {
  ...
  punksOfferedForSale(param0: BigInt): punks__punksOfferedForSaleResult {
    ...
    return new punks__punksOfferedForSaleResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toAddress(),
      result[3].toBigInt(),
  ...
  try_punksOfferedForSale(
    param0: BigInt,
  ): ethereum.CallResult<punks__punksOfferedForSaleResult> {
    ...
    return ethereum.CallResult.fromValue(
      new punks__punksOfferedForSaleResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toAddress(),
        value[3].toBigInt(),
  ...
  punkBids(param0: BigInt): punks__punkBidsResult {
    let result = super.call(
      'punkBids',
    ...
    return new punks__punkBidsResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toAddress(),
      result[3].toBigInt(),
  ...
  try_punkBids(param0: BigInt): ethereum.CallResult<punks__punkBidsResult> {
    let result = super.tryCall(
      'punkBids',
      'punkBids(uint256):(bool,uint256,address,uint256)',
      [ethereum.Value.fromUnsignedBigInt(param0)],
